...
export default function TimeDisplay(props) {
    const downIndicatorClassName = (props.timerState === "running" ? "down-indicator down-indicator-active" : "down-indicator");
    const downIndicatorSrc = (props.timerState === "running" ? props.icons["DownIndicator"]["Active"] : props.icons["DownIndicator"]["Inactive"]);
